...
for t = 1:N
    ...
    e_t = y_t - y_hat(t);
    gamma_t = r / (alpha + phi_t' * phi_t);
    theta_hat = theta_hat + gamma_t * phi_t * e_t;
...
plot(x_raw, y_hat, 'r--', 'LineWidth', 2, 'DisplayName', ['$\hat{y}$ (order = ', num2str(order), ')']);
xlabel('x'); ylabel('y');
